...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        ...
        accent: "#FF8C00",      // Orange Brand
        surface: "#f8fafc",     // Soft Gray Background
        offwhite: "#FAFAF9",    // Warm White
        canvas: "#F5F5F5",      // Neutral Canvas
  ...
  'pi-blue-light':  '#3B82F6',
      ...
      fontFamily: {
        // Display font for big titles (Impact look)
        display: ["Syncopate", "sans-serif"],
        // Heading font for section titles and buttons
        heading: ["Space Grotesk", "sans-serif"],
        // Body font for readable text
        body:  ["Inter", "sans-serif"],
        // Alternative for nav/buttons
