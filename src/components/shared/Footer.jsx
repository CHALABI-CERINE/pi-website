...
const SocialLink = ({ href, icon: Icon, label, gradient, isCustomIcon = false }) => (
  <motion.a
    ...
    aria-label={label}
  >
    {isCustomIcon ?  Icon : <Icon className="w-5 h-5" />}
  </motion.a>
);
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 mb-12">
          ...
          <motion.div variants={itemVariants}>
            <h4 
              className="text-xs font-bold uppercase tracking-[0.2em] text-[#FF6B00] mb-6"
              style={{ fontFamily:  '"Space Grotesk", sans-serif' }}
            >
              Navigation
            </h4>
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a 
                  ...
                  style={{ fontFamily: '"Inter", sans-serif' }}
                >
                  <div className="p-2 rounded-lg bg-white/5 group-hover:bg-[#FF6B00]/20 transition-colors">
              ...
              <li>
                ...
                >
                  ...
                  <div>
                    <span className="block text-white/40 text-xs mb-1">Adresse</span>
                    USTHB, Chem.  d'Alia<br />
                    Bab Ezzouar, Alger
                  </div>
                </a>
              </li>
            ...
            >
              <div className="relative h-24 bg-[#1e293b] flex items-center justify-center">
                ...
                <span className="absolute bottom-2 right-2 text-[10px] text-white/40 font-medium">
                  Voir sur Maps →
                </span>
              </div>
            </motion.a>
